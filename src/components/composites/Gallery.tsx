  ...
  return (
    <div className={cx(styles.sequence, className)}>
      {images.map((image) => (
        ...
        // they focus as they pass. None is ever the LCP element on the front
        // page: the statement above them owns the first screen, which
        // PageSections.module.css enforces.
